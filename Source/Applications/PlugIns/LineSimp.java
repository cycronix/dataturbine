...
//
// 2006/03/16  JPW  Moved from com.rbnb.utility to the PlugIns directory
// 2006/03/13  JPW  Put in firewalls/checks for any data which is NaN;
//                  discard vertices where the x or y data is NaN
// 2005/11/09  WHF  Created from linesimp.m, which was created 2005/08/16.
//

// JPW 03/16/2006 Moved from com.rbnb.utility to the PlugIns directory
...
public class LineSimp
{
	...
	/**
	  ...
	  */
	public static boolean[] simplify(double[] x, double[] y, double tol)
	{
	 ...
	 */
	private static void simpimp(double tol2, double[] x, double[] y,
