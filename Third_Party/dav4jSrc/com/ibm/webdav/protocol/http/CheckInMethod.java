...
/**
 * Executes the WebDAV Delta-V CheckIn method.
 * 
 * @author Michael Bell
 * @version $Revision: 1.1 $
 * @since November 13, 2003
 */
public class CheckInMethod extends WebDAVMethod {

	public static final String METHOD_NAME = "CHECKIN";
	
	private static Logger m_logger = Logger.getLogger(CheckInMethod.class.getName());
	...
	public WebDAVStatus execute() throws WebDAVException {
		...
		try {
			...
			m_logger.log(Level.WARNING, "Check in Method: unhandled exception: ", exc);
