...
/**
 * Executes the WebDAV Delta-V VersionControl method.
 * 
 * @author Michael Bell
...
public class VersionControlMethod extends WebDAVMethod {
	private static Logger m_logger = Logger.getLogger(VersionControlMethod.class.getName());
