 ...
 */
public class VersionedResourceSelector extends TargetSelector {
/**
 * Get the selector key for this TargetSelector. In this case,
 * the versioned resource itself is selected rather than a specific
 * revision.
 *
...
public String getSelectorKey() throws WebDAVException {
	return "versioned-resource "+targetSelector;
}
}
